            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
                ...
                <div class="tab-pane fade show active" id="custom-tabs-one-2324" role="tabpanel" aria-labelledby="custom-tabs-one-2324-tab">
                    <div class="row">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pl2324 as $key => $value) { ?>
                                                <tr class="text-center">
                                                    ...
                                                    <?php if (session()->get('role') != '4') { ?>
                                                        <td>
                                                            <button class="btn btn-warning btn-sm btn-flat" data-toggle="modal" data-target="#edit-pl2324<?= $value['id_pl2324'] ?>"><i class="fas fa-pencil-alt"></i></button>
                                                            <button class="btn btn-danger btn-sm btn-flat" data-toggle="modal" data-target="#delete-pl2324<?= $value['id_pl2324'] ?>"><i class="fas fa-trash"></i></button>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                                <?php
                        ...
                        <!-- /add-modal -->
                        <div class="modal fade" id="add-pl2324">
                        ...
                        <!-- /edit-modal -->
                        <?php foreach ($pl2324 as $key => $value) { ?>
                            <div class="modal fade" id="edit-pl2324<?= $value['id_pl2324'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <?php echo form_open('/edit-pl2324/' . $value['id_pl2324']) ?>
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="">Klub</label>
                                                <select name="id_club" class="form-control">
                        ...
                        <!-- /delete-modal -->
                        <?php foreach ($pl2324 as $key => $value) { ?>
                            <div class="modal fade" id="delete-pl2324<?= $value['id_pl2324'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
                                            <a href="<?= base_url('/delete-pl2324/' . $value['id_pl2324']) ?>" class="btn btn-danger btn-flat">Delete</a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-2223" role="tabpanel" aria-labelledby="custom-tabs-one-2223-tab">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <div class="card-tools">
                                        <?php if (session()->get('role') != '4') { ?>
                                            <button type="button" class="btn btn-tool" data-toggle="modal" data-target="#add-pl2223">
                                                <i class="fas fa-plus"></i> Add Klub
                                            </button>
                                        <?php } ?>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pl2223 as $key => $value) { ?>
                                                <tr class="text-center">
                                                    ...
                                                    <?php if (session()->get('role') != '4') { ?>
                                                        <td>
                                                            <button class="btn btn-warning btn-sm btn-flat" data-toggle="modal" data-target="#edit-pl2223<?= $value['id_pl2223'] ?>"><i class="fas fa-pencil-alt"></i></button>
                                                            <button class="btn btn-danger btn-sm btn-flat" data-toggle="modal" data-target="#delete-pl2223<?= $value['id_pl2223'] ?>"><i class="fas fa-trash"></i></button>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                                <?php
                        ...
                        <!-- /add-modal -->
                        <div class="modal fade" id="add-pl2223">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Add Klub</h4>
                        ...
                        <!-- /edit-modal -->
                        <?php foreach ($pl2223 as $key => $value) { ?>
                            <div class="modal fade" id="edit-pl2223<?= $value['id_pl2223'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Edit Klub</h4>
                                        ...
                                        <?php echo form_open('/edit-pl2223/' . $value['id_pl2223']) ?>
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="">Klub</label>
                                                <select name="id_club" class="form-control">
                        ...
                        <!-- /delete-modal -->
                        <?php foreach ($pl2223 as $key => $value) { ?>
                            <div class="modal fade" id="delete-pl2223<?= $value['id_pl2223'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Delete Klub</h4>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
                                            <a href="<?= base_url('/delete-pl2223/' . $value['id_pl2223']) ?>" class="btn btn-danger btn-flat">Delete</a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-2122" role="tabpanel" aria-labelledby="custom-tabs-one-2122-tab">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <div class="card-tools">
                                        <?php if (session()->get('role') != '4') { ?>
                                            <button type="button" class="btn btn-tool" data-toggle="modal" data-target="#add-pl2122">
                                                <i class="fas fa-plus"></i> Add Klub
                                            </button>
                                        <?php } ?>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pl2122 as $key => $value) { ?>
                                                <tr class="text-center">
                                                    ...
                                                    <?php if (session()->get('role') != '4') { ?>
                                                        <td>
                                                            <button class="btn btn-warning btn-sm btn-flat" data-toggle="modal" data-target="#edit-pl2122<?= $value['id_pl2122'] ?>"><i class="fas fa-pencil-alt"></i></button>
                                                            <button class="btn btn-danger btn-sm btn-flat" data-toggle="modal" data-target="#delete-pl2122<?= $value['id_pl2122'] ?>"><i class="fas fa-trash"></i></button>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                                <?php
                        ...
                        <!-- /add-modal -->
                        <div class="modal fade" id="add-pl2122">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Add Klub</h4>
                        ...
                        <!-- /edit-modal -->
                        <?php foreach ($pl2122 as $key => $value) { ?>
                            <div class="modal fade" id="edit-pl2122<?= $value['id_pl2122'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Edit Klub</h4>
                                        ...
                                        <?php echo form_open('/edit-pl2122/' . $value['id_pl2122']) ?>
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="">Klub</label>
                                                <select name="id_club" class="form-control">
                        ...
                        <!-- /delete-modal -->
                        <?php foreach ($pl2122 as $key => $value) { ?>
                            <div class="modal fade" id="delete-pl2122<?= $value['id_pl2122'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Delete Klub</h4>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
                                            <a href="<?= base_url('/delete-pl2122/' . $value['id_pl2122']) ?>" class="btn btn-danger btn-flat">Delete</a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-2021" role="tabpanel" aria-labelledby="custom-tabs-one-2021-tab">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <div class="card-tools">
                                        <?php if (session()->get('role') != '4') { ?>
                                            <button type="button" class="btn btn-tool" data-toggle="modal" data-target="#add-pl2021">
                                                <i class="fas fa-plus"></i> Add Klub
                                            </button>
                                        <?php } ?>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pl2021 as $key => $value) { ?>
                                                <tr class="text-center">
                                                    ...
                                                    <?php if (session()->get('role') != '4') { ?>
                                                        <td>
                                                            <button class="btn btn-warning btn-sm btn-flat" data-toggle="modal" data-target="#edit-pl2021<?= $value['id_pl2021'] ?>"><i class="fas fa-pencil-alt"></i></button>
                                                            <button class="btn btn-danger btn-sm btn-flat" data-toggle="modal" data-target="#delete-pl2021<?= $value['id_pl2021'] ?>"><i class="fas fa-trash"></i></button>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                                <?php
                        ...
                        <!-- /add-modal -->
                        <div class="modal fade" id="add-pl2021">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Add Klub</h4>
                        ...
                        <!-- /.modal -->
                        <!-- /edit-modal -->
                        <?php foreach ($pl2021 as $key => $value) { ?>
                            <div class="modal fade" id="edit-pl2021<?= $value['id_pl2021'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Edit Klub</h4>
                                        ...
                                        <?php echo form_open('/edit-pl2021/' . $value['id_pl2021']) ?>
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="">Klub</label>
                                                <select name="id_club" class="form-control">
                        ...
                        <!-- /delete-modal -->
                        <?php foreach ($pl2021 as $key => $value) { ?>
                            <div class="modal fade" id="delete-pl2021<?= $value['id_pl2021'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Delete Klub</h4>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
                                            <a href="<?= base_url('/delete-pl2021/' . $value['id_pl2021']) ?>" class="btn btn-danger btn-flat">Delete</a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-1920" role="tabpanel" aria-labelledby="custom-tabs-one-1920-tab">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <div class="card-tools">
                                        <?php if (session()->get('role') != '4') { ?>
                                            <button type="button" class="btn btn-tool" data-toggle="modal" data-target="#add-pl1920">
                                                <i class="fas fa-plus"></i> Add Klub
                                            </button>
                                        <?php } ?>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="1920" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $no = 1;
                                            foreach ($pl1920 as $key => $value) { ?>
                                                <tr class="text-center">
                                                    <td style="border: none;" class="<?= ($no == 1 || $no == 2 || $no == 3 || $no == 4) ? 'bg-blue color-palette' : (($no == 5) ? 'bg-orange color-palette' : ($no == 6 ? 'bg-green color-palette' : ($no == 18 || $no == 19 || $no == 20 ? 'bg-red color-palette' : ''))) ?>"></td>
                                                    <td><?= $no++ ?></td>
                                                    <td><?= $value['name_club'] ?></td>
                                                    <td><?= $value['play'] ?></td>
                                                    <td><?= $value['win'] ?></td>
                                                    ...
                                                    <?php if (session()->get('role') != '4') { ?>
                                                        <td>
                                                            <button class="btn btn-warning btn-sm btn-flat" data-toggle="modal" data-target="#edit-pl1920<?= $value['id_pl1920'] ?>"><i class="fas fa-pencil-alt"></i></button>
                                                            <button class="btn btn-danger btn-sm btn-flat" data-toggle="modal" data-target="#delete-pl1920<?= $value['id_pl1920'] ?>"><i class="fas fa-trash"></i></button>
                                                        </td>
                                                    <?php } ?>
                                                </tr>
                                                <?php
                        ...
                        <!-- /add-modal -->
                        <div class="modal fade" id="add-pl1920">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Add Klub</h4>
                        ...
                        <!-- /edit-modal -->
                        <?php foreach ($pl1920 as $key => $value) { ?>
                            <div class="modal fade" id="edit-pl1920<?= $value['id_pl1920'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Edit Klub</h4>
                                        ...
                                        <?php echo form_open('/edit-pl1920/' . $value['id_pl1920']) ?>
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="">Klub</label>
                                                <select name="id_club" class="form-control">
                        ...
                        <!-- /delete-modal -->
                        <?php foreach ($pl1920 as $key => $value) { ?>
                            <div class="modal fade" id="delete-pl1920<?= $value['id_pl1920'] ?>">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Delete Klub</h4>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
                                            <a href="<?= base_url('/delete-pl1920/' . $value['id_pl1920']) ?>" class="btn btn-danger btn-flat">Delete</a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
