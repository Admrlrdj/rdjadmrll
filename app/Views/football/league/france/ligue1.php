...
<script>
    function DataLigue1() {
        //* 23/24
        $.ajax({
            url: 'https://api-football-standings.azharimm.dev/leagues/fra.1/standings',
            method: 'GET',
            dataType: 'JSON',
            data: {
                'season': '2023',
            ...
            success: function(result) {
                if (result) {
                    ...
                    $.each(standings, function(i, data) {
                        let rowClass = (i == 0 || i == 1 || i == 2) ? 'bg-blue color-palette' : (i == 3) ? 'bg-orange color-palette' : (i == 4) ? 'bg-green color-palette' : (i == 15) ? 'bg-warning color-palette' : (i == 16 || i == 17 ? 'bg-red color-palette' : '');
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result) {
                    ...
                    $.each(standings, function(i, data) {
                        let rowClass = (i == 0 || i == 1) ? 'bg-blue color-palette' : (i == 2) ? 'bg-info color-palette' : (i == 3) ? 'bg-orange color-palette' : (i == 4) ? 'bg-green color-palette' : (i == 17) ? 'bg-warning color-palette' : (i == 18 || i == 19) ? 'bg-red color-palette' : '';
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result) {
                    ...
                    $.each(standings, function(i, data) {
                        let rowClass = (i == 0 || i == 1) ? 'bg-blue color-palette' : (i == 2) ? 'bg-info color-palette' : (i == 3 || i == 4) ? 'bg-orange color palette' : (i == 17) ? 'bg-warning color-palette' : (i == 18 || i == 19) ? 'bg-red color-palette' : '';
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result) {
                    ...
                    $.each(standings, function(i, data) {
                        let rowClass = (i == 0 || i == 1) ? 'bg-blue color-palette' : (i == 2) ? 'bg-info color-palette' : (i == 3) ? 'bg-orange color palette' : (i == 17) ? 'bg-warning color-palette' : (i == 18 || i == 19) ? 'bg-red color-palette' : '';
