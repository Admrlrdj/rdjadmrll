...
<script>
    function DataBundesliga() {
        //* 23/24
        $.ajax({
            url: 'https://api-football-standings.azharimm.dev/leagues/ger.1/standings',
            method: 'GET',
            dataType: 'JSON',
            data: {
                'season': '2023',
            ...
            success: function(result) {
                if (result) {
                    ...
                    $.each(standings, function(i, data) {
                        let rowClass = (i == 0 || i == 1 || i == 2 || i == 3) ? 'bg-blue color-palette' : (i == 4 || i == 5) ? 'bg-orange color-palette' : (i == 6 ? 'bg-green color-palette' : (i == 15 ? 'bg-warning color-palette' : (i == 16 || i == 17 ? 'bg-red color-palette' : '')));
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result) {
                    ...
                    $.each(standings, function(i, data) {
                        let rowClass = (i == 0 || i == 1 || i == 2 || i == 3) ? 'bg-blue color-palette' :
                            (i == 4 || i == 5) ? 'bg-orange color-palette' :
                            (i == 17 || i == 18 || i == 19 ? 'bg-red color-palette' : '');
