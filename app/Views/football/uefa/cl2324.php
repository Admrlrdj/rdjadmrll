        ...
        <div class="card card-primary card-tabs">
            <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-knockout-tab" data-toggle="pill" href="#custom-tabs-one-knockout" role="tab" aria-controls="custom-tabs-one-knockout" aria-selected="false">Knockout Stage</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
